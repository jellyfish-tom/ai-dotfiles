...
description: 'Use this skill for security audits, PR security review, vulnerability scanning, secret exposure checks, auth and access-control review, dependency risk checks, or requests such as "is this secure?", "review for security issues", "check for vulnerabilities", or "scan this codebase". It reasons across data flows and catches issues that pattern-only scanning misses.'
---
